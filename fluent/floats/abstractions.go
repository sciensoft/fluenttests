...
// FluentT[T constraints.Float] is a type returned by calling "contracts.Fluent[~float32 | ~float64](t)"
...
// Additional[T constraints.Float] is a type returned by some helpful testing methods,
// providing basic additive test chaining with "And()".
type Additional[T constraints.Float] struct {
	*Comparable[T]
}

// Comparable[T any] is a type returned by calling "fluentObj.It(0.9999).Should()",
// encapsulating a "*Testable[T]" object for further testing, and providing
// all the floats package's helpful set of methods with signatures declared at
