...
func be[T String](t *testing.T, subject T, comparable T) {
	if subject != comparable {
		t.Errorf("Expected value [%v] is not equal to [%v].", subject, comparable)
	}
}

func notBe[T String](t *testing.T, subject T, comparable T) {
	if subject == comparable {
		t.Errorf("Expected value [%v] is not equal to [%v].", subject, comparable)
	}
}

func lowerThan[T String](t *testing.T, subject T, comparable T) {
...
func lowerThanOrEqualTo[T String](t *testing.T, subject T, comparable T) {
...
func greaterThan[T String](t *testing.T, subject T, comparable T) {
...
func greaterThanOrEqualTo[T String](t *testing.T, subject T, comparable T) {
